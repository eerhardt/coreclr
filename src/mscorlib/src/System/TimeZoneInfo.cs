...
#pragma warning restore 0420
        ...
        private AdjustmentRule GetPreviousAdjustmentRule(AdjustmentRule rule, int? ruleIndex)
        {
            ...
            {
                if (object.ReferenceEquals(rule, _adjustmentRules[i]))//.Equals(_adjustmentRules[i]))
                {
        ...
        {
            int? ruleIndex;
            return GetAdjustmentRuleForTime(dateTime, dateTimeisUtc, out ruleIndex);
        }

        private AdjustmentRule GetAdjustmentRuleForTime(DateTime dateTime, out int? ruleIndex)
        {
            return GetAdjustmentRuleForTime(dateTime, false, out ruleIndex);
        }
